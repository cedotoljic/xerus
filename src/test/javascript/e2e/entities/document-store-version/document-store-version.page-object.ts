...
export class DocumentStoreVersionComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-document-store-version div table .btn-danger'));
  title = element.all(by.css('jhi-document-store-version div h2#page-heading span')).first();
...
export class DocumentStoreVersionUpdatePage {
  pageTitle = element(by.id('jhi-document-store-version-heading'));
...
export class DocumentStoreVersionDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-documentStoreVersion-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-documentStoreVersion'));

...
export class DocumentStoreHistoryComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-document-store-history div table .btn-danger'));
  title = element.all(by.css('jhi-document-store-history div h2#page-heading span')).first();
...
export class DocumentStoreHistoryUpdatePage {
  pageTitle = element(by.id('jhi-document-store-history-heading'));
...
export class DocumentStoreHistoryDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-documentStoreHistory-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-documentStoreHistory'));

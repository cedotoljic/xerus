...
public class DocumentStoreVersionResourceIT {
    ...
    public void createDocumentStoreVersion() throws Exception {
        ...
        restDocumentStoreVersionMockMvc.perform(post("/api/document-store-versions").with(csrf())
            ...
            .content(TestUtil.convertObjectToJsonBytes(documentStoreVersion)))
        ...
        assertThat(testDocumentStoreVersion.getContentType()).isEqualTo(DEFAULT_CONTENT_TYPE);
    ...
    public void updateDocumentStoreVersion() throws Exception {
        // Initialize the database
        documentStoreVersionService.save(documentStoreVersion);
        ...
        restDocumentStoreVersionMockMvc.perform(put("/api/document-store-versions").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(updatedDocumentStoreVersion)))
            .andExpect(status().isOk());
        ...
        assertThat(testDocumentStoreVersion.getContentType()).isEqualTo(UPDATED_CONTENT_TYPE);

...
public class DocumentStoreHistoryResourceIT {
    ...
    public void createDocumentStoreHistory() throws Exception {
        ...
        DocumentStoreHistoryDTO documentStoreHistoryDTO = documentStoreHistoryMapper.toDto(documentStoreHistory);
        restDocumentStoreHistoryMockMvc.perform(post("/api/document-store-histories").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(documentStoreHistoryDTO)))
        ...
        assertThat(testDocumentStoreHistory.getThumbnail()).isEqualTo(DEFAULT_THUMBNAIL);
        assertThat(testDocumentStoreHistory.getThumbnailContentType()).isEqualTo(DEFAULT_THUMBNAIL_CONTENT_TYPE);
        ...
        assertThat(testDocumentStoreHistory.isVersionControlled()).isEqualTo(DEFAULT_VERSION_CONTROLLED);
        assertThat(testDocumentStoreHistory.getVersion()).isEqualTo(DEFAULT_VERSION);
    ...
    public void updateDocumentStoreHistory() throws Exception {
        ...
        updatedDocumentStoreHistory
            ...
            .owner(UPDATED_OWNER)
            .responsible(UPDATED_RESPONSIBLE);
        DocumentStoreHistoryDTO documentStoreHistoryDTO = documentStoreHistoryMapper.toDto(updatedDocumentStoreHistory);
        ...
        assertThat(testDocumentStoreHistory.getThumbnail()).isEqualTo(UPDATED_THUMBNAIL);
        assertThat(testDocumentStoreHistory.getThumbnailContentType()).isEqualTo(UPDATED_THUMBNAIL_CONTENT_TYPE);
        ...
        assertThat(testDocumentStoreHistory.isVersionControlled()).isEqualTo(UPDATED_VERSION_CONTROLLED);
        assertThat(testDocumentStoreHistory.getVersion()).isEqualTo(UPDATED_VERSION);
